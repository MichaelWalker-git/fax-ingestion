...
import QuestionAnsweringResultBlock from './QuestionAnsweringResultBlock.tsx'
...
interface QuestionAnsweringResultModalProps {
  open: boolean
  onClose: () => void
  processingDocumentResults: ProcessingResult[]
}

export default function QuestionAnsweringResultModal({
  open,
  onClose,
  processingDocumentResults,
}: QuestionAnsweringResultModalProps) {
