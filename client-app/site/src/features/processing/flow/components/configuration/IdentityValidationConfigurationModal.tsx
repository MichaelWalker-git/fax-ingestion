...
interface IdentityValidationConfigurationModalProps {
  open: boolean
  onClose: () => void
  nodeId: string
}

export default function IdentityValidationConfigurationModal({
  open,
  onClose,
  nodeId,
}: IdentityValidationConfigurationModalProps) {
